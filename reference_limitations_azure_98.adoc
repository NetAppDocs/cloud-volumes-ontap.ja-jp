...
---
= Azure での Cloud Volumes ONTAP 9.8 に関する既知の制限事項
:hardbreaks:
:nofooter: 
:icons: font
:linkattrs: 
...
[role="lead"]
以下に示す既知の制限事項は、 Microsoft Azure の Cloud Volumes ONTAP に固有のものです。また、必ず確認してください link:reference_limitations_98.html["すべてのクラウドプロバイダで Cloud Volumes ONTAP 9.8 を使用する場合の制限事項"]。
