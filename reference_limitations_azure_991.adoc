---
sidebar: sidebar 
permalink: reference_limitations_azure_991.html 
...
[role="lead"]
以下に示す既知の制限事項は、 Microsoft Azure の Cloud Volumes ONTAP に固有のものです。また、必ず確認してください link:reference_limitations_991.html["すべてのクラウドプロバイダでの Cloud Volumes ONTAP 9.9.1 の制限事項"]。
